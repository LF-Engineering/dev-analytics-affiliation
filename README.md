...
- Call example clients:
  ...
  - `` JWT_TOKEN=`cat secret/lgryglicki.token` start='2000-01-01T00:00' end='2021-01-01T00:00' ./sh/curl_delete_enrollment.sh odpi/egeria 0000142135434a2b963c916185862168806fb1f5 CNCF 2>/dev/null | jq ``.
- Some special utils:
