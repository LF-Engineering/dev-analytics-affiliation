...
- Call example clients:
  ...
  - `` JWT_TOKEN=`cat secret/lgryglicki.token` new_start='2012-08-01T00:00' new_end='2013-10-15T00:00' new_is_project_specific=false ./sh/curl_put_edit_enrollment_by_id.sh odpi/egeria 12632 ``.
