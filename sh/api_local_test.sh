...
export ELASTIC_LOG_URL="`cat helm/da-affiliation/secrets/ELASTIC_LOG_URL.test.secret`"
export ELASTIC_LOG_USERNAME="`cat helm/da-affiliation/secrets/ELASTIC_LOG_USERNAME.test.secret`"
export ELASTIC_LOG_PASSWORD="`cat helm/da-affiliation/secrets/ELASTIC_LOG_PASSWORD.test.secret`"
